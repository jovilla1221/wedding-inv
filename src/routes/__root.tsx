...
function NotFoundComponent() {
  return (
    <div className="screen-section flex items-center justify-center bg-background px-4">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Lora:ital,wght@0,400;0,500;0,600;0,700;1,400&family=Inter:wght@300;400;500;600&family=Pinyon+Script&family=Amita:wght@400;700&display=swap",
      },
    ],
  }),
